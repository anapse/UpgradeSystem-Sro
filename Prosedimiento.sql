...
as
	...
	if (@Plus_Item >= @Plus_Req and @Active != 0) 
		BEGIN     
			UPDATE	SRO_VT_SHARD.._Items Set RefItemID= @ID_Upgrade ,OptLevel = 0 ,MagParamNum = 0 , Variance = 0,MagParam1=0,MagParam2=0,MagParam3=0,MagParam4=0,MagParam5=0,MagParam6=0,MagParam7=0,MagParam8=0,MagParam9=0,MagParam10=0
		END
	End
